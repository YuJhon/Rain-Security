...
##### Spring Social 提供接口 ConnectController,但是没有提供视图
```java
/*
...
```
![SpringSocialConnectMethod01](../../photos/SpringSocialConnectMethod01.png)

![springSocialViewMethod02](../../photos/springSocialViewMethod02.png)
...
```
![UnBindWeixinConfig](../../photos/UnBindWeixinConfig.png)
...
import com.jhon.rain.security.core.social.RainConnectView;
